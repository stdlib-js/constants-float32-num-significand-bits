...
```javascript
FLOAT32_NUM_SIGNIFICAND_BITS = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-num-significand-bits@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-num-significand-bits@v0.1.1-umd/browser.js"></script>
```
